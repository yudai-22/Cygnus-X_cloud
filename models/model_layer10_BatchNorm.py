...
class Conv3dAutoencoder(nn.Module):
    def __init__(self, latent):
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ConvTranspose3d(32, 32, kernel_size=6, stride=2, padding=1), 
            nn.BatchNorm3d(32), nn.ReLU(True),
            nn.ConvTranspose3d(32, 64, kernel_size=5, stride=2, padding=1), 
            nn.BatchNorm3d(64), nn.ReLU(True),
            nn.ConvTranspose3d(64, 64, kernel_size=4, stride=2, padding=0),
            nn.BatchNorm3d(64), nn.ReLU(True),
